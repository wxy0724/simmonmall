<template>
  <el-dialog
    ...
    <el-form-item label="浠樻�炬柟寮忋€� 1:鍦ㄧ嚎浠樻�� 2:璐у埌浠樻�俱€�" prop="paymentWay">
      <el-input v-model="dataForm.paymentWay" placeholder="浠樻�炬柟寮忋€� 1:鍦ㄧ嚎浠樻�� 2:璐у埌浠樻�俱€�"></el-input>
    </el-form-item>
    ...
    <el-form-item label="宸ヤ綔鍗曞�囨敞" prop="taskComment">
      <el-input v-model="dataForm.taskComment" placeholder="宸ヤ綔鍗曞�囨敞"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          paymentWay: [
            { required: true, message: '浠樻�炬柟寮忋€� 1:鍦ㄧ嚎浠樻�� 2:璐у埌浠樻�俱€�不能为空', trigger: 'blur' }
          ],
          taskStatus: [
          ...
          taskComment: [
            { required: true, message: '宸ヤ綔鍗曞�囨敞不能为空', trigger: 'blur' }
          ]
        }
      }
    },
