<template>
  <el-dialog
    ...
    <el-form-item label="搴撳瓨鏁�" prop="stock">
      <el-input v-model="dataForm.stock" placeholder="搴撳瓨鏁�"></el-input>
    </el-form-item>
    <el-form-item label="sku_name" prop="skuName">
      <el-input v-model="dataForm.skuName" placeholder="sku_name"></el-input>
    </el-form-item>
    <el-form-item label="閿佸畾搴撳瓨" prop="stockLocked">
      <el-input v-model="dataForm.stockLocked" placeholder="閿佸畾搴撳瓨"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          stock: [
            { required: true, message: '搴撳瓨鏁�不能为空', trigger: 'blur' }
          ],
          skuName: [
            { required: true, message: 'sku_name不能为空', trigger: 'blur' }
          ],
          stockLocked: [
            { required: true, message: '閿佸畾搴撳瓨不能为空', trigger: 'blur' }
          ]
        }
      }
    },
